...
public class SchemaTest {
  ...
  public void testSchemaBuilder() {
    Schema schema =
        new Schema.SchemaBuilder().addSingleValueDimension("svDimension", FieldSpec.DataType.INT)
            .addMultiValueDimension("mvDimension", FieldSpec.DataType.STRING, ",").addMetric("metric", FieldSpec.DataType.INT)
            .addTime("incomingTime", TimeUnit.DAYS, FieldSpec.DataType.LONG).build();
    ...
    Assert.assertEquals(schema.getDimensionSpec("mvDimension").getDelimiter(), ",");
